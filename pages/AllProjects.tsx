...
import { useProjects } from '../lib/payload';
  ...
  return (
    <Layout>
      <section className="pt-32 md:pt-48 pb-24 bg-neutral-50 min-h-screen">
        <SEO
          title="All Projects"
          description="A complete archive of strategies, automations, and RAG pipelines shipped for startups and enterprises."
          url="https://ezekiel.ai/projects"
        />
        <div className="max-w-6xl mx-auto px-4 md:px-6">
                  ...
                  <Link to={`/projects/${project.slug}`} className="group block">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tags?.map((tagItem: any) => (
                        <span key={tagItem.tag || tagItem} className="text-xs font-medium text-neutral-500 bg-white border border-neutral-200 px-3 py-1.5 rounded-full">
                          {tagItem.tag || tagItem}
                        </span>
                      ))}
                    </div>
          ...
          <div className="mt-24 pt-12 text-center">
            <h3 className="text-2xl font-semibold mb-6">Need a custom implementation?</h3>
