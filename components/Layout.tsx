...
export const Header: React.FC = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/90 backdrop-blur-md border-b border-neutral-100 py-4' : 'bg-transparent py-6'}`}>
        ...
        {isMobileMenuOpen && (
          <div className="fixed inset-0 bg-white z-[60] flex flex-col items-center justify-center gap-10 h-[100dvh] w-screen">
             <NavItem 
               ...
               className="text-[32px] font-medium text-neutral-900 tracking-tight"
             />
             <NavItem 
               to="/#services" 
               label="Services" 
