...
import { useProfile, useHero } from '../lib/payload';
...
export const Hero: React.FC = () => {
  ...
  // Fallback to profile if hero collection is empty
  const role = hero?.role || profile.role;
  const headline = hero?.headline || profile.headline;
  const subheadline = hero?.subheadline || profile.subheadline;
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 w-full grid md:grid-cols-12 gap-12 items-center">
