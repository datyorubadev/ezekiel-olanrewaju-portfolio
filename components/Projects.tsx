              ...
              <FadeIn key={project.slug} delay={index * 0.1}>
                <Link to={`/projects/${project.slug}`} className="group block h-full flex flex-col">
                  <div className="aspect-[4/3] bg-neutral-800 rounded-lg overflow-hidden mb-4 relative">
                    ...
                    />
                    <div className="absolute top-4 right-4 bg-neutral-900 p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  <div className="flex flex-col flex-grow">
                    ...
                    <div className="flex gap-2 mt-auto">
                      {project.tags?.slice(0, 3).map((tagItem: any) => (
                        <span key={tagItem.tag || tagItem} className="text-xs text-neutral-500 border border-neutral-800 px-2 py-1 rounded">
                          {tagItem.tag || tagItem}
                        </span>
                      ))}
                    </div>
