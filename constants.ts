...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    problem: "Writers were bottlenecked by drafting initial outlines and sourcing stock images.",
    solution: "Created an n8n workflow that takes a keyword, researches top competitors, drafts an outline, writes the content, and generates a branded header image using SDXL.",
    metrics: [
  ...
  },
  {
    ...
    problem: "Lawyers spend hours reviewing standard NDAs and MSAs for non-standard clauses.",
    solution: "Built a document parsing pipeline using unstructured.io and Claude 3 Opus to flag high-risk clauses against a playbok.",
    metrics: [
